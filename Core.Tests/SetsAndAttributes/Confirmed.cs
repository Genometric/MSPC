...
namespace Genometric.MSPC.Core.Tests.SetsAndAttributes
{
    public class Confirmed
    {
        ...
        private ReadOnlyDictionary<uint, Result<Peak>> CreateStringentPeaksAndConfirmThem()
        {
            ...
            var sB = new Bed<Peak>();
            sB.Add(new Peak(left: 5, right: 12, value: 1e-12, summit: 8, name: "Peak"), _chr, _strand);
        ...
        public void ConfirmTwoOverlappingWeakPeaks()
        {
            ...
            var sB = new Bed<Peak>();
            sB.Add(new Peak(left: 5, right: 12, value: 7e-5, summit: 10, name: "Peak"), _chr, _strand);
        ...
        public void SourceOfConfirmedPeakEqualsInput()
        {
            ...
            var sB = new Bed<Peak>();
            var sBP = new Peak(left: 5, right: 15, value: 1e-12, summit: 10, name: "Peak");
