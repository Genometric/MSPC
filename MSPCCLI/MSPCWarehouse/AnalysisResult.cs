...
using Polimi.DEIB.VahidJalili.MSPC.Warehouse.Classes;
using System;
...
namespace Polimi.DEIB.VahidJalili.MSPC.Warehouse
{
        ...
        where Metadata : IChIPSeqPeak, new()
    {
        ...
        public class SupportingPeak : IComparable<SupportingPeak>
        {
            ...
            /// </summary>
            public UInt32 sampleIndex { set; get; }
            ...
            private int CompareWithThis(SupportingPeak that)
            {
                ...
                if (this.sampleIndex != that.sampleIndex)
                    return this.sampleIndex.CompareTo(that.sampleIndex);
