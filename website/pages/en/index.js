    ...
    return (
      <SplashContainer>
        <div className="inner">
          <ProjectTitle />
          <PromoSection>
            <Button href={docUrl('quick_start.html', language)}>Quick Start</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
